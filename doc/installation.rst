...
First download and install the prerequisites:
   * `Python 3.11.x <http://www.python.org/>`_ -- 32 or 64 bit version depending on which version of VapourSynth you want to install
...
First download and decompress the prerequisites:
   * `Python 3.11.x <http://www.python.org/>`_ -- 32 or 64 bit embeddable version
...
* It also needs both `32bit <https://www.python.org/>`_ and `64bit <https://www.python.org/>`_ Python 3.11.x (the msvc project assumes that you installed python for all users.)
